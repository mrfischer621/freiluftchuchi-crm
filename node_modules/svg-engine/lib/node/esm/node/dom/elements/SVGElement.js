...
export class SVGElement extends Node {
    ...
    get innerText() {
        var _a, _b;
        return (_b = (_a = this.childNodes.filter(node => node.nodeType === NodeType.TEXT_NODE)[0]) === null || _a === void 0 ? void 0 : _a.nodeValue) !== null && _b !== void 0 ? _b : "";
    }
    ...
    get firstElementChild() {
        var _a;
        return (_a = this.childNodes.filter(node => node.nodeType === NodeType.ELEMENT_NODE)[0]) !== null && _a !== void 0 ? _a : null;
    }
    ...
    get parentElement() {
        var _a;
        return ((_a = this.parentNode) === null || _a === void 0 ? void 0 : _a.nodeType) === NodeType.ELEMENT_NODE ? this.parentNode : null;
    }
