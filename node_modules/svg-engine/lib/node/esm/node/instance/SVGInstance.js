...
export class SVGInstance {
    ...
    attr(attributeNameOrAttributeObjectOrUndefined, valueOrUndefined) {
        ...
        var _a;
        const attributes = Object.entries(convertNamedNodeMapToObject(this.element.attributes)).reduce((previous, [key, value]) => (Object.assign(Object.assign({}, previous), { [value.name]: isNaN(+value.value) ? value.value : +value.value })), {});
